...
# Import SentinelDeployer directly from the module
sentinel_module_path = os.path.join(os.path.dirname(__file__), 'sentinel.py')
spec = importlib.util.spec_from_file_location("sentinel_module", sentinel_module_path)
